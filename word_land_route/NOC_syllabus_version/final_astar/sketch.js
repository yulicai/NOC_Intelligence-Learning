...
var start_word = "evolution";
var end_word = "techniques";
...
function setup() {
    ...
    for (var i = 0; i < cols; i++) {
        // var textX = (data[words_array[i]][0]*10 + 200) * 5;
        // var textY = (data[words_array[i]][1]*10 + 200) * 2;
...
function draw() {
    ...
    for (var i = 0; i < closedSet.length; i++) {
        closedSet[i].show(color(255, 190, 0), text_size);
    }

    for (var i = 0; i < openSet.length; i++) {
        openSet[i].show(color(0, 255, 0), text_size);
    }
    for (var i = 0; i < path.length; i++) {
        path[i].show(color(255, 50, 0), 30);
        textSize(20);
        fill(20);
        noStroke();
        rectMode(CENTER);
    ...
    start.show(color(255, 50, 0), 40);
    end.show(color(255, 50, 0), 40);
